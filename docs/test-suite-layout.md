...
| `test_dashboard.py` | 24 | 64 | The dashboard read path: what renders, in which column, from which cache |
...
| `test_my_plan.py` | 6 | 15 | `/mein-plan/` |
| `test_landing.py` | 2 | 7 | The landing page: what it renders, and where it sends a visitor |
| `test_summary.py` | 18 | 73 | The AI weekly summary: prompt, parsing, resolution, caches |
